...
линтером, корпус сканера текстов и полноту реестра его категорий.
...
Требуется Node.js 18+. Текущее состояние: **831 кейс, 0 отказов**. На PowerShell проходит 764,
67 пропущено по условиям среды; на python проходит 782, пропущено 49. Порядок работы с тестами -
