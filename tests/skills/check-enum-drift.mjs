...
const compile  = parsePs1EnumMap('skills/1c-meta-compile/scripts/meta-compile.ps1', '$script:validEnumValues');
const validate = parsePs1EnumMap('skills/1c-meta-validate/scripts/meta-validate.ps1', '$validPropertyValues');
const edit     = parsePs1EnumMap('skills/1c-meta-edit/scripts/meta-edit.ps1', '$script:validEnumValues');
