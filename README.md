...
| Скил | Описание |
|------|----------|
| `1c-cf-init` | Создать пустую конфигурацию (scaffold XML), версии формата 2.17-2.21 |
...
| Скил | Описание |
|------|----------|
| `1c-meta-compile` | Создать объект метаданных из JSON DSL (37 типов) |
...
| `1c-erf-init` | Создать пустой отчет |
| `1c-erf-build` | Собрать ERF |
| `1c-erf-dump` | Разобрать ERF |
| `1c-erf-validate` | Валидация отчета |
...
| `claude-env-setup` | Установка и обновление окружения: опись -> план -> установка выбранного, без затирания чужого |
| `docx-from-sample` | Новый DOCX в оформлении готового образца: стили, нумерация, таблицы, колонтитулы из файла-образца |
