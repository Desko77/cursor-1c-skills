...
**99 скилов** для работы с конфигурациями, расширениями, обработками, формами, макетами, запросами, ролями, подсистемами, базами данных, веб-публикацией и веб-тестированием 1С, а также разработкой под 1С 7.7, правилами обмена «Конвертация данных» и интеграцией с Mobile SMARTS (Клеверенс).
...
| `transcribe` | Транскрибация аудио (локально, faster-whisper + sherpa-onnx) и видео (Gemini API) |
| `transcribe-audio-local` | Только аудио, только локально, self-contained - для передачи без облака |
...
| `dehumanize-ai-text` | Переписывание AI-текста в живой человеческий стиль |
| `claude-md-bootstrap` | Генерация файла-контекста проекта для AI-агента (CLAUDE.md) |
