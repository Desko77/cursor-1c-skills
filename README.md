...
**76 скилов** для работы с конфигурациями, расширениями, обработками, формами, макетами, запросами, ролями, подсистемами и базами данных 1С.
...
| `1c-web-test` | Тестирование веб-приложений 1С |
