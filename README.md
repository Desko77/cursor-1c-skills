...
данных СКД, имена таблиц и полей в запросе, вызовы общих модулей. Ни платформа, ни EDT, ни запущенная
...
Полный перечень с описанием каждого скила - в разделе [Скилы](#скилы-114) ниже.
