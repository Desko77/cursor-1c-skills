...
def main():
    ...
    try:
        ...
        result_file = os.path.join(temp_dir, "load_dt_result.txt")
        ...
        exit_code = write_platform_verdict(
            ...
            result_file,
            log_content,
            f"Infobase restored successfully from: {args.InputFile}",
            "Error restoring infobase. Check for active sessions - restore needs exclusive access.",
