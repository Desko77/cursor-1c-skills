...
2. Если пользователь указал **базу по имени** - ищи совпадение в таком порядке:
 ...
 2. По `aliases` (совпадение в массиве с учетом морфологии: "тестовую" = "тестовая" = "тестовой")
 3. По `name` (нечеткое совпадение с учетом морфологии и регистра)
...
Спроси у пользователя интерактивно:
