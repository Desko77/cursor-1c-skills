...
Редактирует конкретный объект метаданных: реквизиты, ТЧ, измерения, ресурсы. Для состава конфигурации — используй `/cf-edit`.
...
```powershell
powershell.exe -NoProfile -File skills/1c-meta-edit/scripts/meta-edit.ps1 -ObjectPath "<path>" -Operation <op> -Value "<val>"
```
