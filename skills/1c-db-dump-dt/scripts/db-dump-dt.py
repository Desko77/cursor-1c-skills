...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Dump 1C infobase to DT file",
        allow_abbrev=False,
    )
    ...
    try:
        ...
        result_file = os.path.join(temp_dir, "dump_dt_result.txt")
        ...
        exit_code = write_platform_verdict(
            ...
            result_file,
            log_content,
            f"Infobase dumped successfully to: {args.OutputFile}",
            "Error dumping infobase. Check for active sessions - dump needs exclusive access.",
