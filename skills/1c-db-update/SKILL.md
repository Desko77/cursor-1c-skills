...
> Параметры фонового обновления (`-BackgroundStart`, `-BackgroundFinish`, `-BackgroundCancel`, `-BackgroundSuspend`, `-BackgroundResume`) описаны в спецификации пакетного режима (`docs/build-spec.md`), но в текущей версии скрипта **не реализованы**. При необходимости — вызывай `1cv8.exe` напрямую через Bash с нужными параметрами.
