...
| `Namespace` | нет | Выбрать пакет по пространству имен (когда путь - корень исходников) |
...
Если известно только имя типа - укажи `-Name` и корень исходников: тип найдется
...
1С и с учетом ограничений (`Строка(6)`, `Число(18,2)`), обязательность и коллекции -
...
и только те, что в нем встретились.
