...
Добавляет в модуль объекта обработки функцию `СведенияОВнешнейОбработке`, необходимую для регистрации в подсистеме "Дополнительные отчеты и обработки" БСП.
...
| доп отчет, глобальный отчет | ДополнительныйОтчет | `ВидОбработкиДополнительныйОтчет` |
| заполнение, заполнить | ЗаполнениеОбъекта | `ВидОбработкиЗаполнениеОбъекта` |
| отчет (назначаемый, для объекта) | Отчет | `ВидОбработкиОтчет` |
...
- Добавить еще команду: `/epf-bsp-add-command`
