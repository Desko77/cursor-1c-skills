...
```powershell
powershell.exe -NoProfile -File 'skills/1c-subsystem-edit/scripts/subsystem-edit.ps1' -SubsystemPath '<path>' -Operation add-content -Value 'Catalog.Товары'
```
