...
Правила:
- Граница на переходе `[а-яе][А-ЯЕ]` и `[a-z][A-Z]`
...
| `ПланВидовРасчетаСсылка.Xxx` | `ChartOfCalculationTypesRef.Xxx` |
...
## 4. Сокращенная запись реквизитов
...
Создает графу без ссылок, без индексации.
...
## 13. Признаки учета (accountingFlags)
...
Массив имен. Каждый признак - Boolean-тип. Синоним авто из CamelCase.

---

## 14. Признаки учета субконто (extDimensionAccountingFlags)
