...
| `OutFile` | нет | Записать отчет в файл |
...
Часть дефектов платформа не диагностирует: неразрешенный тип из чужого пространства
имен она молча подменяет на `xs:anyType`, и пакет выглядит загруженным, пока
