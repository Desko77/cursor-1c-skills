...
5. **БСП** (`/1c-bsp-registration` + `/1c-bsp-command`): если дополнительная обработка/отчет
...
- БСП-регистрация нужна только для обработок, подключаемых через "Дополнительные отчеты и обработки"
