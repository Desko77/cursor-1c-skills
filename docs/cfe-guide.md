...
Claude вызовет `/cfe-diff -Mode B` - найдет блоки `#Вставка` и проверит их наличие в конфигурации.
...
Заимствует объекты из основной конфигурации в расширение. Создает минимальные XML-файлы с `ObjectBelonging=Adopted` и `ExtendedConfigurationObject`.
